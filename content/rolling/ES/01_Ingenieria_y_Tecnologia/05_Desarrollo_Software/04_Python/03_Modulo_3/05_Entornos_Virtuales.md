@title: Entornos virtuales y empaquetado
@icon: 📦
@description: venv, pip, pyproject.toml.
@order: 5

# Entornos virtuales y empaquetado

Esta lección profundiza en **Entornos virtuales y empaquetado** con ejemplos ejecutables en Python 3.11+.
