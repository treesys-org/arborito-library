...
@icon: 🔢
@description: ndarray, broadcasting, slicing.
@order: 1

# NumPy: arrays y vectorización

Esta lección profundiza en **NumPy: arrays y vectorización** con ejemplos ejecutables en Python 3.11+.
