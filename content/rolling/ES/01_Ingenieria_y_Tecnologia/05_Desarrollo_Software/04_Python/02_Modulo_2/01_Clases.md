@title: Clases, objetos y dataclasses
@icon: 🧱
@description: POO, self, métodos especiales, slots.
@order: 1

# Clases, objetos y dataclasses

Esta lección profundiza en **Clases, objetos y dataclasses** con ejemplos ejecutables en Python 3.11+.
