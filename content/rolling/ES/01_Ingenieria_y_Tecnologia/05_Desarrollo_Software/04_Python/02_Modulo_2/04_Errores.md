@title: Excepciones y trazas
@icon: ⚠️
@description: try/except/finally, raise, excepciones encadenadas.
@order: 4

# Excepciones y trazas

Esta lección profundiza en **Excepciones y trazas** con ejemplos ejecutables en Python 3.11+.
