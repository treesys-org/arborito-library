@title: Decoradores y closures
@icon: 🎀
@description: funciones de orden superior, functools.wraps.
@order: 3

# Decoradores y closures

Esta lección profundiza en **Decoradores y closures** con ejemplos ejecutables en Python 3.11+.
