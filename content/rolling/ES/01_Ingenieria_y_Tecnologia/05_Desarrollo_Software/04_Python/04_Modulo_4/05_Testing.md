@title: pytest y fixtures
@icon: 🧪
@description: tests, parametrización, mocks, coverage.
@order: 5

# pytest y fixtures

Esta lección profundiza en **pytest y fixtures** con ejemplos ejecutables en Python 3.11+.
