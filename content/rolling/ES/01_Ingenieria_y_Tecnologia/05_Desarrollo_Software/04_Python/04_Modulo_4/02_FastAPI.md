@title: FastAPI: rutas y Pydantic
@icon: ⚡
@description: app, Depends, validación de modelos.
@order: 2

# FastAPI: rutas y Pydantic

Esta lección profundiza en **FastAPI: rutas y Pydantic** con ejemplos ejecutables en Python 3.11+.
