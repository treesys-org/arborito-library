@title: Colecciones integradas
@icon: 🧺
@description: list, tuple, dict, set, comprensiones.
@order: 4

# Colecciones integradas

Esta lección profundiza en **Colecciones integradas** con ejemplos ejecutables en Python 3.11+.
