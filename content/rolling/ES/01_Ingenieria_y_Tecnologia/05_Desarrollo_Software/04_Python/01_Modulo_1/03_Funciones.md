@title: Funciones: parámetros, *args y **kwargs
@icon: 📦
@description: def, valores por defecto, solo keyword, anotaciones.
@order: 3

# Funciones: parámetros, *args y **kwargs

Esta lección profundiza en **Funciones: parámetros, *args y **kwargs** con ejemplos ejecutables en Python 3.11+.
