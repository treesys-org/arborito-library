...
@icon: 🔀
@description: if/elif/else, match, bucles for/while, break/continue.
@order: 2

# Estructuras de control

Esta lección profundiza en **Estructuras de control** con ejemplos ejecutables en Python 3.11+.
