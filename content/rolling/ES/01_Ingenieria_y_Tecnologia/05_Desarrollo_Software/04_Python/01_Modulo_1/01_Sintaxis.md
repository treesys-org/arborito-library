@title: Sintaxis, variables y tipos dinámicos
@icon: 📜
@description: Python 3: REPL, indentación, f-strings, tipos básicos.
@order: 1

# Sintaxis, variables y tipos dinámicos

Esta lección profundiza en **Sintaxis, variables y tipos dinámicos** con ejemplos ejecutables en Python 3.11+.
