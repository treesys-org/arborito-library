@title: HTTP and ethical scraping
@icon: 🌐
@description: requests, httpx, robots.txt, rate limits.
@order: 4

# HTTP and ethical scraping

This lesson deepens **HTTP and ethical scraping** with runnable Python 3.11+ examples.
