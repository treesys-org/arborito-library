@title: FastAPI: routes and Pydantic
@icon: ⚡
@description: app, Depends, model validation.
@order: 2

# FastAPI: routes and Pydantic

This lesson deepens **FastAPI: routes and Pydantic** with runnable Python 3.11+ examples.
