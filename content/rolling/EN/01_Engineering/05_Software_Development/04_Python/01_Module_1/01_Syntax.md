@title: Syntax, variables, and dynamic typing
@icon: 📜
@description: Python 3: REPL, indentation, f-strings, basics.
@order: 1

# Syntax, variables, and dynamic typing

This lesson deepens **Syntax, variables, and dynamic typing** with runnable Python 3.11+ examples.
