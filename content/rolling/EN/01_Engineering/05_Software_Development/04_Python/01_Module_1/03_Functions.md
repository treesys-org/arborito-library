@title: Functions: parameters, *args, **kwargs
@icon: 📦
@description: def, defaults, keyword-only, annotations.
@order: 3

# Functions: parameters, *args, **kwargs

This lesson deepens **Functions: parameters, *args, **kwargs** with runnable Python 3.11+ examples.
