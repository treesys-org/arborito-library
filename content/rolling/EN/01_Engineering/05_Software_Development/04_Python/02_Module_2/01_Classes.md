@title: Classes, objects, dataclasses
@icon: 🧱
@description: OOP, self, dunder methods, slots.
@order: 1

# Classes, objects, dataclasses

This lesson deepens **Classes, objects, dataclasses** with runnable Python 3.11+ examples.
